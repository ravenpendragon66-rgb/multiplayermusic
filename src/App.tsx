      ...
      <div className="min-h-screen bg-[#0a0a0a] text-white flex items-center justify-center p-6 font-sans">
        ...
        >
          ...
          <div>
            ...
            <p className="text-zinc-400">Entre em uma sala para ouvir m̼sica com seus amigos em tempo real.</p>
          </div>
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white font-sans selection:bg-emerald-500/30">
      ...
      <header className="p-4 sm:p-6 flex flex-col sm:flex-row gap-4 sm:gap-0 sm:justify-between sm:items-center max-w-5xl mx-auto w-full">
        ...
        <div className="flex items-center gap-3 sm:gap-4 flex-wrap">
          ...
          >
            ...
            <span className="text-sm font-semibold">Adicionar M̼sica</span>
          </button>
        </div>
      </header>
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 py-8 grid lg:grid-cols-2 gap-10 lg:gap-12 items-start">
        {/* Left: Album Art */}
        <div className="relative aspect-[4/5] sm:aspect-square max-w-md mx-auto w-full">
        ...
        <div className="space-y-8">
          <div className="space-y-2">
            ...
            >
              {currentTrack?.title || 'Nenhuma m̼sica'}
            </motion.h2>
            <motion.p 
            ...
            >
              {currentTrack?.artist || 'Adicione m̼sicas para come̤ar'}
            </motion.p>
          </div>
          ...
          <div className="pt-8 border-t border-zinc-800">
            ...
            <div className="space-y-2 max-h-[45vh] sm:max-h-64 overflow-y-auto pr-2 custom-scrollbar">
